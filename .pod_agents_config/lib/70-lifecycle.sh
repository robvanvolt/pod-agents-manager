...
Environment=DEFAULT_MODEL_CONTEXT_SIZE=${DEFAULT_MODEL_CONTEXT_SIZE}
Environment=POD_DEFAULT_MODEL_CONTEXT_SIZE=${DEFAULT_MODEL_CONTEXT_SIZE}
Environment=FORGEJO_URL=${FORGEJO_URL}
Environment=FORGEJO_USER=${FORGEJO_USER}
Environment=FORGEJO_EMAIL=${FORGEJO_EMAIL}
Environment=FORGEJO_TOKEN=${FORGEJO_TOKEN}
Environment=POD_FORGEJO_URL=${FORGEJO_URL}
